...
const Icon = ({ name = '', color, content }) => {
    ...
    switch (name) {
        ...
        case 'logo_v5':
            return (
                ...
                >
                    <title>PayPal</title>
                    <path
                        d="M140.871 45.9625C140.871 70.5804 118.151 99.625 83.7759 99.625H50.666L49.0398 109.879L41.3157 159.25H0.165413L24.9188 0.25H91.5904C114.04 0.25 131.702 12.7622 138.206 30.1528C140.058 35.0764 140.962 40.4065 140.871 45.9625Z"
                        fill="#002991"
                    />
                    <path
                        d="M164.586 91.6749C160.024 119.229 136.309 139.375 108.258 139.375H85.2666L75.6904 199H34.766L41.3157 159.25L49.0399 109.879L50.666 99.6249H83.7759C118.105 99.6249 140.871 70.5803 140.871 45.9624C157.765 54.6803 167.612 72.2968 164.586 91.6749Z"
                        fill="#60CDFF"
                    />
                    <path
                        d="M140.871 45.9625C133.78 42.2585 125.197 40 115.847 40H60.0163L50.666 99.625H83.7759C118.105 99.625 140.871 70.5804 140.871 45.9625Z"
                        fill="#008CFF"
                    />
                </svg>
            );
        ...
        case 'pay-monthly-card':
            return (
                <svg width="96" height="60" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <title>PayPal</title>
                    <rect width="96" height="60" rx="4" fill="#003087" />
                    <path
                        d="M53.707 16h24.711c1.583 0 2.707 1.15 2.707 2.382v23.67c0 1.231-1.124 2.382-2.707 2.382H53.707c-1.584 0-2.707-1.15-2.707-2.381V18.382C51 17.15 52.123 16 53.707 16Z"
                        stroke="#0070E0"
                        stroke-width="2"
                        stroke-linejoin="round"
                    />
                    <path
                        d="M73.672 15v3.382M58.453 15l-.001 3.382"
                        stroke="#AAE542"
                        stroke-width="2"
                        stroke-linecap="round"
                    />
                    <circle cx="59.302" cy="25.864" r="2.536" fill="#69D5BA" />
                    <circle cx="59.302" cy="34.317" r="2.536" fill="#69D5BA" />
                    <circle cx="66.06" cy="25.864" r="2.536" fill="#69D5BA" />
                    <circle cx="66.06" cy="34.317" r="2.536" fill="#69D5BA" />
                    <circle cx="72.825" cy="25.864" r="2.536" fill="#69D5BA" />
                    <circle cx="72.825" cy="34.317" r="2.536" fill="#fff" />
                    <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
