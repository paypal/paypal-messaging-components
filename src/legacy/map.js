...
// Image banners that map to an existing style banner
export const dimensionsStyleMap = {
    // AL SAC - Finance Portal Borderless
...
// All image banners that support style
export const styles = {
    // AL NI-FP-G24-WWW-Img
...
// All standard dimension only image banners
