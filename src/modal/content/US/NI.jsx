...
const NI = () => (
    <section id="ni-content" className="content">
        ...
        >
            <ul className="spaced">
                <li>
                    A minimum monthly payment is required and may or may not pay off the promotional purchase by the end
                    of the 6 month period.
                </li>
                <li>
                    No interest will be charged on the purchase if you pay it off in full within 6 months. If you do
                    not, interest will be charged on the purchase from the purchase date at the Purchase APR applicable
                    to your account.
                </li>
                <li>
                    For New Accounts: Variable Purchase APR is 25.99%. The APR is accurate as of 9/1/2019 and will vary
                    with the market based on the Prime Rate (as defined in your credit card agreement). Minimum interest
                    charge is $2.00.
                </li>
                <li>
                    Individual items that are less than $99 qualify for special financing when combined for a total of
                    $99 or more in a single transaction.
                </li>
                <li>
        ...
        <Accordion title="Buy now and pay over time when you spend $98.99 or less">
            <ul className="spaced">
                ...
                <li>
                    We&apos;ll send you email reminders when your payments are due. You can keep track of your account
                    and view your statements online at any time.
                </li>
            </ul>
        </Accordion>
        ...
        <Accordion title="About PayPal Credit">
            <p>
                PayPal Credit is a digital, reusable credit line available to purchase goods and services from thousands
                of online stores. Use PayPal Credit to shop anywhere PayPal is accepted.
            </p>
            <p>
                Whether you&apos;re buying the perfect gift or purchasing a new couch, you can get 6 months special
                financing on purchases of $99 or more. The best part? This isn&apos;t a one-time offer. You can enjoy
                paying over time every time you shop with PayPal Credit.
            </p>
        ...
        <p>
            ...
            US customers who are of legal age in their state of residence. You must pay with PayPal Credit to get the
            offers. Minimum purchase required is before shipping and tax. Offers not valid on previous purchases,
