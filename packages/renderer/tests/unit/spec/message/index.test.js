...
import { getMutations, getLocaleStyles } from '@renderer/locale';
import { objectSet } from '@library/common';
...
jest.mock('@renderer/message/styles/fonts.css', () => ({
    default: 'fonts',
    __esModule: true
}));

jest.mock('@renderer/message/styles', () => ({
    default: {
        'layout:text': [['default', '']],
        'layout:flex': [['default', '']],
