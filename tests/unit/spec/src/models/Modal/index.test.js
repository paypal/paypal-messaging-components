...
import getTerms from 'src/services/terms';

jest.mock('src/services/modal', () => jest.fn().mockResolvedValue(''));
jest.mock('src/services/terms', () => jest.fn().mockResolvedValue(''));
jest.mock('src/models/Modal/termsTable', () => () => '');

const mockIframe = document.createElement('iframe');

jest.mock('src/utils/container', () => () => [mockIframe, { insertMarkup: jest.fn().mockResolvedValue() }]);
...
jest.mock('src/models/Modal/utils', () => ({
