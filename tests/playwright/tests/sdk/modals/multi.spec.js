...
modalTest.describe('@US Multi Modals', () => {
    ...
    modalTest('US Modal product list', async ({ navigatePage, loadModal, modalAxeCoreScan }) => {
...
modalTest.describe('@DE Multi Modals', () => {
    modalTest('DE Modal PRODUCT LIST', async ({ navigatePage, loadModal, modalAxeCoreScan }) => {
