...
export const createMockZoidMarkup = ({ component, scriptUID, port, encodedData }) => {
    ...
    const interfaceScript = `<script>var interface = (window.opener ?? window.top).document.querySelector('[data-uid-auto="${scriptUID}"]').outerHTML; document.write(interface);</script>`;
