export default {
    DEV00000000NI: ['US', ['v2_ppc_ni'], 'ppc_ni_nq', 'ppc_ni_nq'],
    DEV0000000NIQ: ['US', ['v2_ppc_ni'], 'ppc_ni_q', 'ppc_ni_q'],
    DEV000NINONUS: ['US', ['v2_ppc_ni'], 'ppc_ni_nq_xb', 'ppc_ni_nq'],
    DEV00NINONUSQ: ['US', ['v2_ppc_ni'], 'ppc_ni_q_xb', 'ppc_ni_q'],
    DEV000000GPLQ: ['US', ['v2_short_term'], 'short_term_q', 'short_term_q'],
    DEV0000000GPL: ['US', ['v2_short_term'], 'short_term_nq', 'short_term_nq'],
    DEV00000GPLNQ: ['US', ['v2_short_term'], 'short_term_nq', 'short_term_nq'],

    // US Long Term
    DEV0USGENERIC: ['US', ['v2_product_list'], 'generic', 'generic'],
    DEV00USLTMQGZ: ['US', ['v2_long_term'], 'long_term_multi_gtz', 'long_term_multi_gtz'],
    DEV00USLTMQEZ: ['US', ['v2_long_term'], 'long_term_multi_eqz', 'long_term_multi_eqz'],
    DEVUSLTMQEZRB: ['US', ['v2_long_term'], 'long_term_multi_eqz_mixed', 'long_term_multi_eqz'],
    DEV00USLTNQEZ: ['US', ['v2_long_term'], 'long_term_nq_eqz', 'long_term_nq_eqz'],
    DEV00USLTNQGZ: ['US', ['v2_long_term'], 'long_term_nq_gtz', 'long_term_nq_gtz'],
    DEV00USLTSQGZ: ['US', ['v2_long_term'], 'long_term_single_gtz', 'long_term_single_gtz'],
    DEV00USLTSQEZ: ['US', ['v2_long_term'], 'long_term_single_eqz', 'long_term_single_eqz'],
    DEVUSLTSQEZRB: ['US', ['v2_long_term'], 'long_term_single_eqz_mixed', 'long_term_single_eqz'],
    ...
    DEV000DEPLEQZ: ['DE', ['long_term'], 'gpl_eqz', 'long_term_nq_eqz'],
    DEV000DEPLGTZ: ['DE', ['long_term'], 'gpl_gtz', 'long_term_nq_gtz'],
    DEV00DEPLQEQZ: ['DE', ['long_term'], 'gplq_eqz', 'long_term_multi_eqz'],
    DEV00DEPLQGTZ: ['DE', ['long_term'], 'gplq_gtz', 'long_term_multi_gtz'],
    DEV0XBDEPLEQZ: ['DE', ['long_term'], 'gpl_eqz-non-de', 'long_term_nq_eqz'],
    DEV0XBDEPLGTZ: ['DE', ['long_term'], 'gpl_gtz-non-de', 'long_term_nq_gtz'],
    DEVXBDEPLQEQZ: ['DE', ['long_term'], 'gplq_eqz-non-de', 'long_term_multi_eqz'],
    DEVXBDEPLQGTZ: ['DE', ['long_term'], 'gplq_gtz-non-de', 'long_term_multi_gtz'],
    DEV00DEPI30NQ: ['DE', ['pay_in_1'], 'pi30nq', 'pay_in_1_nq'],
    DEV000DEPI30Q: ['DE', ['pay_in_1'], 'pi30q', 'pay_in_1_q'],
    DEV0000DEPI30: ['DE', ['pay_in_1'], 'pi30', 'pay_in_1_q'],
    DEVXBDEPI30NQ: ['DE', ['pay_in_1'], 'pi30nq-non-de', 'pay_in_1_nq'],
    DEV0XBDEPI30Q: ['DE', ['pay_in_1'], 'pi30q-non-de', 'pay_in_1_q'],
    DEV00XBDEPI30: ['DE', ['pay_in_1'], 'pi30-non-de', 'pay_in_1_q'],
    DEV0DEGENERIC: ['DE', ['product_list'], 'generic', 'generic'],
    DEV000XBDEGEN: ['DE', ['product_list'], 'generic-non-de', 'generic'],
    // Multi product modal
    DEV000DEMULTI: ['DE', ['pay_in_1', 'long_term'], 'pi30'],
    DEV0XBDEMULTI: ['DE', ['pay_in_1', 'long_term'], 'pi30-non-de'],

    DEV000000GBPL: ['GB', ['short_term'], 'pl', 'short-term_nq'],
    DEV00000GBPLQ: ['GB', ['short_term'], 'plq', 'short-term_q'],

    DEV0FRGENERIC: ['FR', ['short_term'], 'generic', 'short-term_nq'],
    DEV000000FRPL: ['FR', ['short_term'], 'gpl', 'short-term_nq'],
    DEV00000FRPLQ: ['FR', ['short_term'], 'gplq', 'short-term_q'],
    ...
    DEV0000ESPLNQ: ['ES', ['short_term'], 'short_term_nq', 'short_term_nq'],
    DEV0000ESPLTQ: ['ES', ['long_term'], 'long_term_q', 'long_term_q'],
    DEV000ESPLTNQ: ['ES', ['long_term'], 'long_term_nq', 'long_term_nq'],
    DEV000ESPLEQZ: ['ES', ['long_term'], 'long_term_nq_eqz'],
    DEV00ESPLQEQZ: ['ES', ['long_term'], 'long_term_q_eqz'],

    DEV0000ITPLNA: ['IT', ['short_term'], 'short_term_no_amount', 'short_term_no_amount'],
    DEV00000ITPLQ: ['IT', ['short_term'], 'short_term_q', 'short_term_q'],
    DEV0000ITPLNQ: ['IT', ['short_term'], 'short_term_nq', 'short_term_nq'],
    DEV0000ITPLTQ: ['IT', ['long_term'], 'long_term_q', 'long_term_q'],
    DEV000ITPLTNQ: ['IT', ['long_term'], 'long_term_nq', 'long_term_nq'],
