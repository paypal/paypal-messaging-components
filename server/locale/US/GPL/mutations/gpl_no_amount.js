...
import { logo6x1 } from './mediaQueries';
...
export default {
    ...
    'layout:text': [
        ...
        [
            ...
            ({ textSize }) => ({
                styles: [xSmallFallback(textSize), messageLogoWidth(textSize * 6, textSize * 4, textSize * 1.25)]
            })
        ],
        [
        ...
        [
            'logo.type:none',
            ({ textSize }) => ({
                styles: [xSmallFallback(textSize)],
                logo: false,
                headline: [
                    {
                        tag: 'small',
        ...
        [
            'logo.type:inline',
            ({ textSize }) => ({
                styles: [xSmallFallback(textSize), `.message__logo { width: ${textSize * 4}px }`],
